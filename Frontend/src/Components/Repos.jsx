...
function Repos({ repositories }) {
 ...
 return (
  <div className="w-full min-w-[22rem] max-w-3xl bg-gray-900 text-gray-100 p-6 rounded-lg shadow-lg">
      ...
      >
       ...
       <div className="flex items-center mt-3 text-sm text-gray-400">
        ...
        <button
         ...
         className="ml-4 border border-blue-950 px-3 py-1 rounded-xl"
        >
         Clone
        </button>
       </div>
